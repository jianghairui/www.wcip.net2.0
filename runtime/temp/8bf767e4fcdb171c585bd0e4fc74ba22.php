<?php /*a:1:{s:65:"/var/www/zhi.jianghairui.com/application/api/view/pay/prepay.html";i:1555139816;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    const price = parseFloat('<?php echo htmlentities($info['unit_price']); ?>',2);
    var univalent = 0;
    ...
    var isclick = true,device_num = '<?php echo htmlentities($info['device_num']); ?>',buy_num = 1;
    ...
    buy.onclick = function () {
        ...
        if(isclick) {
            isclick = false;
            window.location.href = "<?php echo url('Pay/pay'); ?>?buy_num=" + buy_num + "&device_num=" + device_num;
